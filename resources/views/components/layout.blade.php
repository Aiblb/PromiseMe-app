    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg bg-light p-0 shadow mb-5">
            <div class="container-fluid">
                ...
                <div class="col-9 offset-0 col-md-7 col-xs-9 offset-md-1 d-flex justify-content-start justify-content-md-center">
                ...
                <div class="col-2 navbar-expand" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 flex-row-reverse">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {!! getIfActive('/') !!}" aria-current="page" href="{{ url('/account') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {!! getIfActive('resources') !!}" aria-current="page" href="{{ url('/newpromise') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
